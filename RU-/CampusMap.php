...
<header>
        <nav>
            ...
            <div class="logo">
                <a href="index.php"><img src="images/rustylishlogo.png" alt="RU Stylish Logo" width="75px"
                        height="65px" class="logo-left"></a>
            </div>
            <ul class="nav-links">
...
<section class="TheMap">
    ...
    <h2>Campus Map:</div>h2>
    <p>RU.. going the right way.</p>
    </div>
    <br>
    <br>
