...
<body>
    ...
    <main>
        <h1> Dummy Page to Meet Requirements</h1>

        <button id = "lang" onclick = "whatLanguage()"> Browser Info</button>
        <button id ="enabled" onclick = "isJavaEnabled()"> Java Enabled? </button>

        <p><strong>SHARE OUR WEBSITE</strong></p>
